...
import com.memong.aos.`data`.dao.MemoDao_Impl
import com.memong.aos.`data`.dao.TagDao
import com.memong.aos.`data`.dao.TagDao_Impl
import com.memong.aos.`data`.dao.TaggingDao
import com.memong.aos.`data`.dao.TaggingDao_Impl
import kotlin.Lazy
      ...
      public override fun onValidateSchema(connection: SQLiteConnection):
        ...
        if (!_infoMemo.equals(_existingMemo)) {
          return RoomOpenDelegate.ValidationResult(false, """
              |memo(com.memong.aos.data.entity.MemoEntity).
              | Expected:
        ...
        if (!_infoTagging.equals(_existingTagging)) {
          return RoomOpenDelegate.ValidationResult(false, """
              |tagging(com.memong.aos.data.entity.TaggingEntity).
              | Expected:
        ...
        if (!_infoTags.equals(_existingTags)) {
          return RoomOpenDelegate.ValidationResult(false, """
              |tags(com.memong.aos.data.entity.TagEntity).
              | Expected:
