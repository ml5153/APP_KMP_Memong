...
internal object PreferenceUtil {
    ...
    const val KEY_SHOW_TUTORIAL_MEMO_MAIN = "$PREF_NAME:KEY_SHOW_TUTORIAL_MEMO_MAIN"
    const val KEY_SHOW_TUTORIAL_MEMO_DETAIL = "$PREF_NAME:KEY_SHOW_TUTORIAL_MEMO_DETAIL"
    const val KEY_SHOW_TUTORIAL_MEMO_EDIT_IS_SHOWING = "$PREF_NAME:KEY_SHOW_TUTORIAL_MEMO_EDIT_IS_SHOWING"
    const val KEY_SHOW_TUTORIAL_MEMO_SAVED_MEMO = "$PREF_NAME:KEY_SHOW_TUTORIAL_MEMO_SAVED_MEMO"
